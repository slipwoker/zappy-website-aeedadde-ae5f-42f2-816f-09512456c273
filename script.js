document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    if (isValid) {
      ...
      simulateFormSubmission(form, function (success) {
        if (success) {
          showFormMessage(form, 'success', form.getAttribute('data-success-message') || 'Your message has been sent successfully!');
          form.reset();
        } else {
          showFormMessage(form, 'error', form.getAttribute('data-error-message') || 'Something went wrong. Please try again.');
        }
  ...
  function clearFormErrors(form) {
    ...
    var formMessages = form.querySelectorAll('.form-message');
  ...
  document.body.addEventListener('input', function (e) {
    ...
    var parent = field.parentNode;
    if (parent) {
      var errorMsg = parent.querySelector('.field-error-message');
      if (errorMsg) {
  ...
  var animationThreshold = 0.15;

  function initScrollAnimations() {
    var elements = document.querySelectorAll(
      '.fade-in, .animate-on-scroll, [data-animate], ' +
      '.feature-card, .service-card, .pricing-card, .team-card, ' +
    ...
    if ('IntersectionObserver' in window) {
      ...
      fallbackScrollAnimation(elements);
    }
  }
  ...
  function injectAnimationStyles() {
    ...
    var translateStart = isRTL ? '20px' : '-20px';
    var translateStartReverse = isRTL ? '-20px' : '20px';
    ...
    var css = [
      ...
      '}',
      '.' + animationTriggerClass + '[data-direction="up"] {',
      '  transform: translateY(30px);',
      '}',
      '.' + animationTriggerClass + '[data-direction="down"] {',
      '  transform: translateY(-30px);',
      '}',
      '.' + animationTriggerClass + '[data-direction="left"] {',
      '  transform: translateX(' + translateStart + ');',
      '}',
      '.' + animationTriggerClass + '[data-direction="right"] {',
      '  transform: translateX(' + translateStartReverse + ');',
      '}',
      '.' + animationTriggerClass + '[data-direction="scale"] {',
      '  transform: scale(0.9);',
      '}',
      '.' + animationTriggerClass + '.' + animationClass + ' {',
      '  opacity: 1;',
  ...
  function fallbackScrollAnimation(elements) {
    function checkVisibility() {
      var windowHeight = window.innerHeight;

      elements.forEach(function (el) {
        if (el.classList.contains(animationClass)) return;

        var rect = el.getBoundingClientRect();
        var visibleThreshold = windowHeight * (1 - animationThreshold);
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'aeedadde-ae5f-42f2-816f-09512456c273',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'aeedadde-ae5f-42f2-816f-09512456c273';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to +97255555555 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'aeedadde-ae5f-42f2-816f-09512456c273';
